    ...
    return (
        <div className="container bg-light mb-3  py-3 shadow-lg classAddContact border rounded">
            <div className="d-flex flex-column flex-md-row align-items-center mb-3">
                <input type="name" className="form-control mb-2 mb-md-0 mx-2" placeholder="Enter name" id="name" />
                <input type="phone" className="form-control mb-2 mb-md-0 mx-2" placeholder="Enter phone" id="family" />
                <input type="email" className="form-control mb-2 mb-md-0 mx-2" placeholder="Enter email" id="email" />
            </div>
